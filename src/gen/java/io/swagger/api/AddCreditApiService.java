...
public abstract class AddCreditApiService {
    public abstract Response addCredit(Long userId,Long extraCredit,String txnId,SecurityContext securityContext) throws NotFoundException;
}
