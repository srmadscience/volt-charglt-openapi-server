...
public abstract class GetAndLockUserApiService {
    public abstract Response getAndLockUser(Long body,SecurityContext securityContext) throws NotFoundException;
}
